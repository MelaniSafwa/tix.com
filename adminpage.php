      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="wrapper text-right">
				<button class="btn btn-dark" onclick="document.location.href='controller/AddMovie.php'" > <span class='glyphicon'> </span>+ Tambah Data</button>
		  </div>
        </div>
      </div>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-sm">
          <tr>
            ...
            $query = " SELECT movieId as id, name as Nama, image as image, genre as genre, director as director, description as description, imdb as imdb from movielist ORDER BY movieId ";
