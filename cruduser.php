  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
	  ...
	  <ul class="nav flex-column mb-2">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="cruduser.php">
              <span data-feather="file-text" class="align-text-bottom"></span>
              User
            </a>
          </li>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Manajemen Akun User</h1>
      </div>
      ...
      <div class="table-responsive">
        ...
        <tr>
            ...
            $query = " SELECT * FROM user WHERE status != '101' ORDER BY userId ";
            ...
            while ($row = $result->fetch_object()){
                ...
                echo '<td><a class="btn btn-warning btn-sm" href="editUser.php?id='.$row->userId.'">Edit</a>&nbsp;&nbsp; 
