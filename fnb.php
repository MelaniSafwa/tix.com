          ...
          <div class="container" style="color:#FF731D;">
            ...
            <div id="navbar" class="navbar-collapse collapse float-right">
              <ul class="nav navbar-nav">
                ...
                <li><a href="jadwal.php" style="color: grey;">Jadwal Film</a></li>
                <li class="active"><a href="fnb.php" style="color: white;">FnB</a></li>
...
require_once('db.php');
// Execute the query
$query = " SELECT nama_menu AS nama_menu, harga AS harga FROM menulist";
...
while ($row = $result->fetch_object()){
    ...
    echo '<td><a href="javascript:void(0)" onclick="openLoginModal()"; class="btn btn-primary btn-xs" style="color:#BE2623; border-color: #BE2623;">Buy FnB</a></td>';
    echo '</tr>';
	$i++;
}
echo '</table>';
