	...
	<div class="bg">
		...
		<div class="container">  
			<form id="contact" action="addTimeSlot.php" method="post" enctype="multipart/form-data">
				...
				<h2  style="text-align: center;    font-family: cursive"><b>Add TimeSlot</b></h2><br>
			...
			<div class="wrapper">
				<button style="text-align: center;" class="btn btn-default" onclick="document.location.href='../crudTimeSlot.php'" ><span class='glyphicon glyphicon-chevron-left'> </span>BACK TO THE ADMIN PAGE</button>
			</div>
		</div>
	</div>
...
class AddProduct{
	public function productAdd($conn)
	{
		...
		header ("Location: ../crudTimeSlot.php" );
	}
}
?>