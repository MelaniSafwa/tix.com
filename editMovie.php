	...
	<div class="bg">
		...
		<div class="container">  
			<form id="contact" action="addMovie.php" method="post" enctype="multipart/form-data">
				<h2  style="text-align: center;    font-family: cursive"><b>Edit Movie</b></h2>
				...
				class="MovieGenre" type="submit" name="submit" value="Update"> 
				<p class="copyright"></p>
				<p></p>
			...
			<div class="wrapper">
				<button class="btn btn-default" onclick="document.location.href='adminpage.php'" > <span class='glyphicon glyphicon-chevron-left'> </span>CANCEL</button>
			</div>
