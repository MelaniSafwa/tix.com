  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
	  ...
	  <ul class="nav flex-column mb-2">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="crudorders.php">
              <span data-feather="file-text" class="align-text-bottom"></span>
              Orders
            </a>
          </li>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive">
        ...
        <tr>
            ...
            $query = " SELECT showOrderId as id, date as tanggal, timeslot as timeslot, theater as theater, movieName as film, seat as seat from showorder ORDER BY showOrderId ";
            ...
            while ($row = $result->fetch_object()){
                ...
                echo '<td>'.$row->film.'</td> ';
                echo '<td>'.$row->seat.'</td> ';
                echo '<td> <a class="btn btn-danger btn-sm" href="delete_order.php?id='.$row->id.'">Delete</a>
                        </td>';
                echo '</tr>';
                $i++;
            }
