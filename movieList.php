...
<body>
 ...
 <div class="container">
  ...
  <div class="panel with-nav-tabs panel-success">
    <div class="panel-heading" style="background-color:#1D3557">
      <ul class="nav nav-tabs">
        <li class="active"><a href="#nowshowing" style="color:black;" data-toggle="tab">Showing Now</a></li>
        <!-- <li class="active"><a href="#" style="color:black;" data-toggle="tab">FnB</a></li> -->
      </ul>
    </div>
            ...
            <div class='col-md-3 col-sm-12'>
              <div class='card-container'>
                <div class='card'>
                  ...
                  <!-- end front panel -->
                  <div class='back' style='background-color: #0B2545;'>
                    <div class='content'>
                      <div class='main'>
                        <h4 class='text-center' style='color: white'>".$row->Name ."</h4>
                        <p class='text-center' style='color: white'>".$row->Description ." </p>
                      </div>
                      <div style='margin-top: 4vw; color: #BE2623;' class='buy_ticket'>
