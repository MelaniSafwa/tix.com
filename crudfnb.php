  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
	  ...
	  <ul class="nav flex-column mb-2">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="crudfnb.php">
              <span data-feather="file-text" class="align-text-bottom"></span>
              FnB
            </a>
          </li>
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="wrapper text-right">
				<button class="btn btn-dark" onclick="document.location.href='controller/addFnB.php'" > <span class='glyphicon'> </span>+ Tambah Data</button>
		  </div>
        </div>
      </div>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-sm">
          <tr>
            ...
            $query = " SELECT * FROM menulist ORDER BY id_menu ";
            ...
            while ($row = $result->fetch_object()){
                ...
                echo '<td>
                        <a class="btn btn-danger btn-sm" href="delete_fnb.php?id='.$row->id_menu.'">Delete</a>
                        </td>';
                echo '</tr>';
                $i++;
            }
